...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        setLoading(true);
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authApi"].login({
                email,
                password
            });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success(`Добро пожаловать, ${data.user.name}`);
            router.push("/");
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0b2k0t7._.js.map